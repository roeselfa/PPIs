 ...
 *
 */
public class DurationMeasure extends BaseMeasure {
	 ...
	 */
	public DurationMeasure(String id, String name, String description, String scale, String unitOfMeasure,
	...
	public DurationMeasure setComputeUnfinished(boolean computeUnfinished) {
	...
	public DurationMeasure setDuration(String duration) {
		this.duration = duration;
		return this;
	}

	public double getMinDuration () {
		String dur = duration.replace("<", "").replace(">", "").replace("=", "");
